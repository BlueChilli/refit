...
namespace Refit.Tests
{
    ...
    public partial class AutoGeneratedIBatchApi : IBatchApi
    {
        ...
        public virtual Task<BatchUser> Login(Login login)
        {
            ...
            return (Task<BatchUser>) methodImpls["Login"](Client, arguments);
        }

        public virtual Task<Company> GetCompany()
        {
            var arguments = new object[] {  };
            return (Task<Company>) methodImpls["GetCompany"](Client, arguments);
        }

        public virtual Task<BatchUser> GetProfile()
        {
            var arguments = new object[] {  };
            return (Task<BatchUser>) methodImpls["GetProfile"](Client, arguments);
        }
