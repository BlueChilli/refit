...
namespace Refit.Tests
{
    ...
    /// <inheritdoc />
    public partial class AutoGeneratedIApiWithDecimal
    {
...
namespace Refit.Tests
{
    ...
    /// <inheritdoc />
    [Preserve]
    public partial class AutoGeneratedIBatchApi : IBatchApi
    {
        /// <inheritdoc />
        public HttpClient Client { get; protected set; }
        readonly ConcurrentDictionary<string, Func<HttpClient, object[], object>> methodImpls = new ConcurrentDictionary<string, Func<HttpClient, object[], object>>();
        ...
        public AutoGeneratedIBatchApi(HttpClient client, IRequestBuilder requestBuilder)
        {
            Client = client;
            this.requestBuilder = requestBuilder;
        }
        ...
        /// <inheritdoc />
        public virtual Task<BatchUser> Login(Login login)
        {
            var arguments = new object[] { login };
            var func = methodImpls.GetOrAdd("Login(Login login)", _ => requestBuilder.BuildRestResultFuncForMethod("Login", new Type[] { typeof(Login) }));
            return (Task<BatchUser>)func(Client, arguments);
        }

        /// <inheritdoc />
        public virtual Task<BatchUser> GetProfile(ProfileParameter parameter)
        {
    ...
    /// <inheritdoc />
    public partial class AutoGeneratedIBatchApi
    {
...
namespace Refit.Tests
{
    ...
    /// <inheritdoc />
    public partial class AutoGeneratedIBodylessApi
    {
...
namespace Refit.Tests
{
    ...
    public partial class AutoGeneratedIHazardApi : IHazardApi
    {
        ...
        public virtual Task<Hazard> Create(MultipartData<Hazard> hazard)
        {
            ...
            var func = methodImpls.GetOrAdd("Create(MultipartData<Hazard> hazard)", _ => requestBuilder.BuildRestResultFuncForMethod("Create", new Type[] { typeof(MultipartData<Hazard>) }));
        ...
        {
            var arguments = new object[] {  };
            var func = methodImpls.GetOrAdd("GetAccoutStatus()", _ => requestBuilder.BuildRestResultFuncForMethod("GetAccoutStatus", new Type[] {  }));
            return (Task<HttpResponseMessage>)func(Client, arguments);
        }
        ...
        public virtual Task<HttpResponseMessage> Update(MultipartData<IdItem> item)
        {
            ...
            var func = methodImpls.GetOrAdd("Update(MultipartData<IdItem> item)", _ => requestBuilder.BuildRestResultFuncForMethod("Update", new Type[] { typeof(MultipartData<IdItem>) }));
            return (Task<HttpResponseMessage>)func(Client, arguments);
        }
...
namespace Refit.Tests
{
    ...
    /// <inheritdoc />
    public partial class AutoGeneratedAuthenticatedClientHandlerTestsIMyAuthenticatedService
    {
...
namespace Refit.Tests
{
    ...
    /// <inheritdoc />
    public partial class AutoGeneratedTestNestedINestedGitHubApi
    {
...
namespace Refit.Tests
{
    ...
    /// <inheritdoc />
    public partial class AutoGeneratedINonGenericInterfaceWithGenericMethod
    {
...
namespace Refit.Tests
{
    ...
    /// <inheritdoc />
    public partial class AutoGeneratedIStreamApi
    {
...
namespace Refit.Tests
{
    ...
    public partial class AutoGeneratedITestApi : ITestApi
    {
        ...
        {
            var arguments = new object[] {  };
            var func = methodImpls.GetOrAdd("UploadFileInfo2()", _ => requestBuilder.BuildRestResultFuncForMethod("UploadFileInfo2", new Type[] {  }));
            return (Task)func(Client, arguments);
        }
        ...
        {
            var arguments = new object[] { message };
            var func = methodImpls.GetOrAdd("Hello(string message)", _ => requestBuilder.BuildRestResultFuncForMethod("Hello", new Type[] { typeof(string) }));
            return (Task<string>)func(Client, arguments);
        }
        ...
        public virtual Task GetHello(string id)
        {
            ...
            var func = methodImpls.GetOrAdd("GetHello(string id)", _ => requestBuilder.BuildRestResultFuncForMethod("GetHello", new Type[] { typeof(string) }));
            return (Task)func(Client, arguments);
        }

        /// <inheritdoc />
        public virtual Task<TestApiObject> SomeTest(TestApiObject obj)
        {
            var arguments = new object[] { obj };
            var func = methodImpls.GetOrAdd("SomeTest(TestApiObject obj)", _ => requestBuilder.BuildRestResultFuncForMethod("SomeTest", new Type[] { typeof(TestApiObject) }));
            return (Task<TestApiObject>)func(Client, arguments);
        }

        /// <inheritdoc />
        public virtual Task SomeTestPost(TestApiObject obj)
        {
            var arguments = new object[] { obj };
            var func = methodImpls.GetOrAdd("SomeTestPost(TestApiObject obj)", _ => requestBuilder.BuildRestResultFuncForMethod("SomeTestPost", new Type[] { typeof(TestApiObject) }));
            return (Task)func(Client, arguments);
        }
...
namespace Refit.Tests
{
    ...
    public partial class AutoGeneratedITestApi2 : ITestApi2
    {
        ...
        {
            var arguments = new object[] { message };
            var func = methodImpls.GetOrAdd("Hello2(string message)", _ => requestBuilder.BuildRestResultFuncForMethod("Hello2", new Type[] { typeof(string) }));
            return (Task<string>)func(Client, arguments);
        }
...
namespace Refit.Tests
{
    ...
    public partial class AutoGeneratedITestApi3 : ITestApi3
    {
        ...
        /// <inheritdoc />
        public virtual Task<string> ChangeTask(MultipartData<TestApiObject> testObject)
        {
            var arguments = new object[] { testObject };
            var func = methodImpls.GetOrAdd("ChangeTask(MultipartData<TestApiObject> testObject)", _ => requestBuilder.BuildRestResultFuncForMethod("ChangeTask", new Type[] { typeof(MultipartData<TestApiObject>) }));
            return (Task<string>)func(Client, arguments);
        }
...
namespace Refit.Tests
{
    ...
    /// <inheritdoc />
    public partial class AutoGeneratedIUseOverloadedGenericMethods<TResponse, TParam, THeader>
        where TResponse : class
        where THeader : struct
    {
